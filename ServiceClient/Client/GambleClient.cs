...
namespace Games.NBall.ServiceContract.Client
{
    ...
    {
        private static IGambleService proxy = ServiceProxy<IGambleService>.Create("NetTcp_IGambleService");
        /// <summary>
        /// 坐庄
        /// </summary>
        ...
        {
            return proxy.ToBeHost(managerId, rateStr, gambleTitleId, hostMoney);
        }
        ...
        {
            return proxy.AddMoney(managerId, gambleTitleId, addMoney);
        }
        ...
        {
            return proxy.AttendGamble(managerId, gambleMoney, optionRateId);
        }
        ...
        {
            return proxy.GetTop10Rank(managerId);
        }
        ...
        {
            return proxy.GetMyRank(managerId);
        }
        ...
        {
            return proxy.GetMyGambleList(managerId);
        }
        ...
        {
            return proxy.GetMyHostList(managerId);
        }
        ...
        {
            return proxy.GetCanHostTitleList();
        }
        ...
        {
            return proxy.GetCanGambleTitleList();
        }
        /// <summary>
        /// 获取竞猜列表
        /// </summary>
        ...
        {
            return proxy.GetGambleByTime(beforeDay, afterDay);
        }
        ...
        {
            return proxy.GetMatchList(managerId, matchDate, isDefault);
        }
        ...
        {
            return proxy.GambleMatch(managerId, matchId, gambleType, pointType);
        }
        ...
        {
            return proxy.GetMyGamble(managerId);
        }
        ...
        {
            return proxy.GetMyActivity(managerId);
        }
        ...
        {
            return proxy.DrawPrize(managerId, step);
        }
        ...
        {
            return proxy.ReleaseMatch(homeName, awayName, matchTime);
        }
        ...
        {
            return proxy.EndMatch(matchId, homeGoals, awayGoals);
        }
        ...
        {
            return proxy.GetMatchTheCalendar();
        }
    }
}
