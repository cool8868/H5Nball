...
{	
    /// <summary>
	/// 对Table dbo.CrossLadder_Hook 的数据映射.
	/// </summary>
	[DataContract]
	[Serializable]
    [ProtoContract]
...
,				System.DateTime expired
        ...
        #region Clone
        public CrossladderHookEntity Clone()
        {
            CrossladderHookEntity entity = new CrossladderHookEntity();
    ...
    /// <summary>
	/// 对Table dbo.CrossLadder_Hook 的输出映射.
	/// </summary>	
    [DataContract]
    [Serializable]
    public partial class CrossladderHookResponse : BaseResponse<CrossladderHookEntity>
    {
