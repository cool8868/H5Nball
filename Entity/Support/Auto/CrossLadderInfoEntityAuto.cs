...
{	
    /// <summary>
	/// 对Table dbo.CrossLadder_Info 的数据映射.
	/// </summary>
	[DataContract]
	[Serializable]
    [ProtoContract]
	public partial class CrossladderInfoEntity
	{
		
		public CrossladderInfoEntity()
		{
		}
...
,				System.DateTime updatetime
        ...
        #region Clone
        public CrossladderInfoEntity Clone()
        {
            CrossladderInfoEntity entity = new CrossladderInfoEntity();
			entity.Idx = this.Idx;
    ...
    /// <summary>
	/// 对Table dbo.CrossLadder_Info 的输出映射.
	/// </summary>	
    [DataContract]
    [Serializable]
    public partial class CrossladderInfoResponse : BaseResponse<CrossladderInfoEntity>
    {
