...
{	
    /// <summary>
	/// 对Table dbo.ActivityEx_History 的数据映射.
	/// </summary>
	[DataContract]
	[Serializable]
    [ProtoContract]
	public partial class ActivityexHistoryEntity
	{
		
		public ActivityexHistoryEntity()
		{
		}
...
,				System.DateTime updatetime
        ...
        #region Clone
        public ActivityexHistoryEntity Clone()
        {
            ActivityexHistoryEntity entity = new ActivityexHistoryEntity();
			entity.Idx = this.Idx;
    ...
    /// <summary>
	/// 对Table dbo.ActivityEx_History 的输出映射.
	/// </summary>	
    [DataContract]
    [Serializable]
    public partial class ActivityexHistoryResponse : BaseResponse<ActivityexHistoryEntity>
    {
