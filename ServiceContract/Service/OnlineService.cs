...
namespace Games.NBall.ServiceContract.Service
{
    ...
    public class OnlineService : IOnlineService
    {
        ...
        {
            ResponseHelper.TryCatch(() => OnlineThread.Instance.RiseOnlineTime(managerId));
        }

        public int GetIndulgeMinutes(string account, Guid managerId)
        {
            return OnlineCore.Instance.GetIndulgeMinutes(account, managerId);
        }
        ...
        {
            return CSDKinterface.Instance.SetStartGameEntity(openId, state, serverId, pf, sessionId, jsNeed, nickName, common);
        }
        /// <summary>
        /// 获得渠道玩家数据
        /// </summary>
        ...
        {
            return CSDKinterface.Instance.GetStartgameEntity(openId);
        }
        ...
        {
            return UserLoginCore.Instance.GetUserLoginRecord(account, platform);
        }
        ...
        {
            return UserLoginCore.Instance.GetAllZoneInfo(platfrom);
        }
        /// <summary>
        /// 无限期封停用户
        /// </summary>
