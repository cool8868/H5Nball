<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMail.aspx.cs" Inherits="Games.NBall.AdminWeb.Tools.SendMail" %>
...
<body>
    ...
    <table class="bgDark" cellspacing="1" cellpadding="2" border="0" style="width: 100%;">
        ...
        <td class="bgWhite">所属区：</td>
            <td class="bgWhite"><asp:DropDownList ID="SZone" runat="server"></asp:DropDownList></td>
            </tr>
        <tr >
