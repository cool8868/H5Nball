<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AccountPage.Master" AutoEventWireup="true" CodeBehind="AuctionInfo.aspx.cs" Inherits="Games.NBall.AdminWeb.Account.AuctionInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <GMC:SelectControl ID="SelectControl1" runat="server" DbCategory="Main" FileName="AuctionInfo" OrderBy="order by Idx desc"
        TableName="V_Auction with(nolock)" TableDescN="拍卖信息" PageSize="10" IsInitData="true" HideTitle="True">
        <WhereList>
        ...
        <FieldList>
            ...
            <GMC:FieldParam FieldName="SellHours" FieldDescN="出售时间" FieldType="String" FieldLen="16"></GMC:FieldParam>
            <GMC:FieldParam FieldName="Status" FieldDescN="状态" FieldType="String" FieldLen="17"></GMC:FieldParam>
            <GMC:FieldParam FieldName="Rowtime" FieldDescN="创建时间" FieldType="String" FieldLen="18"></GMC:FieldParam>
        </FieldList>
    </GMC:SelectControl>
</asp:Content>
