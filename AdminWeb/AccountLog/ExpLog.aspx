<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AccountPage.Master" AutoEventWireup="true" CodeBehind="ExpLog.aspx.cs" Inherits="Games.NBall.AdminWeb.AccountLog.ExpLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="bgDark" cellspacing="1" cellpadding="1" border="0" style="width: 100%;">
        <tr style="height: 25px">
            ...
            <GMC:SelectControl ID="SelectControl1" runat="server" DbCategory="Shadow" FileName="ExpLog" OrderBy="order by Idx desc"
             TableName="Coin_ChargeHistory with(nolock)" TableDescN="经验获取日志" PageSize="20" IsInitData="true" HideTitle="True">
            <WhereList>
                ...
                <GMC:WhereParam Connector="And" FieldLen="0" FieldName="SourceType" FieldType="String"
                    Operator="Equal"/>
                <GMC:WhereParam Connector="And" FieldLen="0" FieldName="Exp" FieldType="Int"
            ...
            <FieldList>
                ...
                <GMC:FieldParam FieldName="Exp" FieldDescN="经验" FieldType="String" FieldLen="8"></GMC:FieldParam>
                <GMC:FieldParam FieldName="IsLevelup" FieldDescN="是否升级" FieldType="String" FieldLen="8"></GMC:FieldParam>
                <GMC:FieldParam FieldName="Level" FieldDescN="等级" FieldType="String" FieldLen="8"></GMC:FieldParam>
