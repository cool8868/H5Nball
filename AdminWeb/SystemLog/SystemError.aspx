<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemError.aspx.cs" Inherits="Games.NBall.AdminWeb.Log.SystemError" %>
...
<body>
    ...
    <div>
    <GMC:SelectControl ID="SelectControl1" runat="server" ShowZone="True" DbCategory="SystemLog" FileName="SystemError"
             TableName="Log_Error with(nolock)" TableDescN="系统信息错误查询" PageSize="20" IsInitData="true">
            <WhereList>
            ...
            <FieldList>
                ...
                <GMC:FieldParam FieldDescN="StackTrace" FieldLen="8" FieldName="StackTrace" FieldType="String" 
                    Title="StackTrace">
                </GMC:FieldParam>
