...
namespace Games.NBall.Dal
{
    ...
    public partial class ConfigSynthesiscardProvider
    {
        #region properties
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public List<ConfigSynthesiscardEntity> LoadRows(IDataReader reader)
        {
            var clt = new List<ConfigSynthesiscardEntity>();
            while (reader.Read())
            {
        ...
        /// 构造函数
        /// </summary>
        public ConfigSynthesiscardProvider()
        {
            this.ConnectionString = ConnectionFactory.Instance.GetConnectionString(DBTYPE);
        }

        public ConfigSynthesiscardProvider(string zoneName)
        {
        ...
        /// GetAll
        /// </summary>
        /// <returns>ConfigSynthesiscardEntity列表</returns>
        /// <remarks>2016/1/19 14:54:27</remarks>
        public List<ConfigSynthesiscardEntity> GetAll()
        {
			var database = new SqlDatabase(this.ConnectionString);
            
            DbCommand commandWrapper = database.GetStoredProcCommand("P_ConfigSynthesiscard_GetAll");
            

            
            List<ConfigSynthesiscardEntity> list = null;
            using (IDataReader reader = database.ExecuteReader(commandWrapper))
            {
        ...
        public bool Delete ( System.Int32 idx,DbTransaction trans=null)
        {
            ...
            DbCommand commandWrapper = database.GetStoredProcCommand("P_ConfigSynthesiscard_Delete");
        ...
        /// <returns></returns>
        /// <remarks>2016/1/19 14:54:27</remarks>
        public bool Insert(ConfigSynthesiscardEntity entity,DbTransaction trans)
        {
            var database = new SqlDatabase(this.ConnectionString);
            DbCommand commandWrapper = database.GetStoredProcCommand("dbo.P_ConfigSynthesiscard_Insert");
