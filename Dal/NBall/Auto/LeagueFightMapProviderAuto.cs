...
namespace Games.NBall.Dal
{
    ...
    public partial class LeagueFightmapProvider
    {
        #region properties
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public List<LeagueFightmapEntity> LoadRows(IDataReader reader)
        {
            var clt = new List<LeagueFightmapEntity>();
            while (reader.Read())
            {
        ...
        /// 构造函数
        /// </summary>
        public LeagueFightmapProvider()
        {
            this.ConnectionString = ConnectionFactory.Instance.GetConnectionString(DBTYPE);
        }

        public LeagueFightmapProvider(string zoneName)
        {
        ...
        /// GetAll
        /// </summary>
        /// <returns>LeagueFightmapEntity列表</returns>
        /// <remarks>2016/6/16 12:47:10</remarks>
        public List<LeagueFightmapEntity> GetAll()
        {
			var database = new SqlDatabase(this.ConnectionString);
            
            DbCommand commandWrapper = database.GetStoredProcCommand("P_LeagueFightmap_GetAll");
            

            
            List<LeagueFightmapEntity> list = null;
            using (IDataReader reader = database.ExecuteReader(commandWrapper))
            {
        ...
        public bool Delete ( System.Guid managerId,DbTransaction trans=null)
        {
            ...
            DbCommand commandWrapper = database.GetStoredProcCommand("P_LeagueFightmap_Delete");
        ...
        /// <returns></returns>
        /// <remarks>2016/6/16 12:47:10</remarks>
        public bool Insert(LeagueFightmapEntity entity,DbTransaction trans=null)
        {
            var database = new SqlDatabase(this.ConnectionString);
            DbCommand commandWrapper = database.GetStoredProcCommand("dbo.P_LeagueFightmap_Insert");
