...
namespace Games.NBall.Bll
{
    ...
    /// AllUaplatform管理类
    /// </summary>
    public static partial class AllUaplatformMgr
    {
        ...
        public static bool Insert(AllUaplatformEntity allUaplatformEntity,DbTransaction trans=null,string zoneId="")
        {
            var provider = new AllUaplatformProvider(zoneId);
            return provider.Insert(allUaplatformEntity,trans);
        }
