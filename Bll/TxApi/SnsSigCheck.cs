...
namespace NS_SnsSigCheck
{
    ...
    public class SnsSigCheck
    {
        ...
        static public string VerifySig2(string method, string url_path, NameValueCollection param, string secret, string sig)
        {
            ...
            // 再计算签名
            return MakeSig(method, url_path, new_param, secret);
        }
