...
{
    /// <summary>
    /// CrossladderExchangerecord管理类
    /// </summary>
    public static partial class CrossladderExchangerecordMgr
    {
        ...
        public static bool Insert(CrossladderExchangerecordEntity crossladderExchangerecordEntity,DbTransaction trans=null,string zoneId="")
        {
            var provider = new CrossladderExchangerecordProvider(zoneId);
            return provider.Insert(crossladderExchangerecordEntity,trans);
        }
